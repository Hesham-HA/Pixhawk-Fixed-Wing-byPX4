...
####### The solution to this is to check the firmware version, and load the V3 manually if not exists [l1](http://px4-travis.s3.amazonaws.com/Firmware/stable/px4fmu-v3_default.px4)
